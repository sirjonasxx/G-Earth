...
import gearth.app.services.internal_extensions.extensionstore.application.entities.categories.CategoryOverview;
import gearth.app.services.internal_extensions.extensionstore.application.entities.installed.InstalledOverview;
import gearth.app.services.internal_extensions.extensionstore.application.entities.queriedoverviews.ByRatingOverview;
import gearth.app.services.internal_extensions.extensionstore.application.entities.queriedoverviews.ByUpdateOverview;
import gearth.app.services.internal_extensions.extensionstore.application.entities.search.SearchOverview;
...
public class GExtensionStoreController implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        webView.getEngine().load(GExtensionStoreController.class.getResource("/gearth/services/internal_extensions/extensionstore/application/webview/index.html").toString());
