...
public class GExtensionStoreCreator extends InternalExtensionFormCreator<GExtensionStore> {
    ...
    public GExtensionStore createForm(Stage stage) throws Exception {
        FXMLLoader loader = new FXMLLoader(GExtensionStoreController.class.getResource("/gearth/services/internal_extensions/extensionstore/application/gextensionstore.fxml"));
