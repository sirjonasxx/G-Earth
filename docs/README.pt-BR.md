...
<p align="center">
    ...
    <a href="docs/README.md" title="(disponível) README em Inglês (Global)">
    ...
    <a href="docs/README.es.md" title="(indisponível) README em Espanhol (Espanha)">
    ...
    <a href="docs/README.pt-BR.md" title="(atual) README en Português (Brasil)">
...
Por favor veja as nossas [diretrizes de contribuições](docs/CONTRIBUTING.md) (PENTENDE) se você está interessado em ajudar!
...
- [Diretrizes de contribuições](docs/CONTRIBUTING.md);
